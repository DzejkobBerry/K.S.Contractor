    ...
    <section className="py-40 px-6 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-32">
          ...
          <p className="text-2xl text-muted font-serif italic max-w-2xl mx-auto">
            {t.process.subtitle}
          </p>
        </div>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full bg-white/5 border border-gold/30 flex items-center justify-center mb-10 group-hover:bg-gold transition-colors duration-500 shadow-[0_0_30px_rgba(212,165,44,0.1)]">
                  <step.icon size={36} className="text-gold group-hover:text-navy transition-colors duration-500" />
                </div>
                
                <span className="text-gold font-mono text-sm mb-4">0{i + 1}</span>
                <h3 className="text-3xl font-bold text-white mb-6 uppercase tracking-tighter">
